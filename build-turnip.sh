...
mesadir="mesa-mesa-25.1.6"
mesaver="https://gitlab.freedesktop.org/mesa/mesa/-/archive/mesa-25.1.6/${mesadir}.zip"
...
ZIP_FILE_MAGISK="Turnip-25.1.6-MAGISK-KSU.zip"
ZIP_FILE_EMULATOR="Turnip-25.1.6-EMULATOR.zip" 
